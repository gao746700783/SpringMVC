...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="../styles/plugins/iCheck/flat/blue.css">
    <!-- Morris chart -->
    <link rel="stylesheet" href="../styles/plugins/morris/morris.css">
    <!-- jvectormap -->
    <link rel="stylesheet" href="../styles/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
    <!-- Date Picker -->
    <link rel="stylesheet" href="../styles/plugins/datepicker/datepicker3.css">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="../styles/plugins/daterangepicker/daterangepicker-bs3.css">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="../styles/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="../styles/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Developers
                ...
                <section class="col-lg-7 connectedSortable">
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body chat" id="chat-box">
                            <!-- chat item -->
                            <div class="item">
                                <img src="../styles/dist/img/user4-128x128.jpg" alt="user image" class="online">
                                <p class="message">
                                    <a href="#" class="name">
                            ...
                            <!-- chat item -->
                            <div class="item">
                                <img src="../styles/dist/img/user3-128x128.jpg" alt="user image" class="offline">
                                <p class="message">
                                    <a href="#" class="name">
                            ...
                            <!-- chat item -->
                            <div class="item">
                                <img src="../styles/dist/img/user2-160x160.jpg" alt="user image" class="offline">
                                <p class="message">
                                    <a href="#" class="name">
...
<script src="../styles/plugins/morris/morris.min.js"></script>
<!-- Sparkline -->
...
<!-- jQuery Knob Chart -->
<script src="../styles/plugins/knob/jquery.knob.js"></script>
<!-- daterangepicker -->
