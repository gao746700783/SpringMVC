...
<head>
    ...
    <link rel="stylesheet" href="../styles/css/weui.css"/>
        ...
        <div class="bd">
            <div class="weui_cells weui_cells_access global_navs">
                ...
                <a class="weui_cell js_cell" href="javascript:;" data-id="actionSheet">
                    <span class="weui_cell_hd"><img src="./images/icon_nav_actionSheet.png" class="icon_nav"
                                                    alt=""></span>
                    <div class="weui_cell_bd weui_cell_primary">
                        <p>ActionSheet</p>
                    </div>
...
<script src="../styles/js/example.js"></script>
</body>
</html>